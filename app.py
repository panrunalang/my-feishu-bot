...
# GCP_REGION 是可选的，因为我们的 FeishuClient 中有默认值
...
# 更新 FeishuClient 的创建方式，不再需要传入 API Key
client = FeishuClient(APP_ID, APP_SECRET, BITABLE_APP_TOKEN, TABLE_ID)


# process_text_message 和 process_image_message 函数保持不变，这里省略...
